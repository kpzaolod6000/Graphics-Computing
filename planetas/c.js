...
function moveSatelite(dataSatelite,dataPlanet,time,daybyOrbit,velocity,distanceAxis,setRotation){
...
var animate = function(){
    ...
    moveSatelite(moon,earth,time,29.5,1,1.6,[0,0.01,0]);

    movePlanets(mars,time,687,24.07,22.8);
    movePlanets(jupiter,time,4339,13.07,77.8);
    movePlanets(saturn,time,10752,9.69,142.6);
    // movePlanets(saturn,time,88,47.87,5.8);
    saturnRing.forEach(ring => moveSatelite(ring,saturn,time,10752,9.69,0.1,[0,0,0.3]));
...
var position_ = [0,0,0];
createRing(5.8,0.02,100,0xffffff,position_,rotation_)
createRing(10.8,0.02,100,0xffffff,position_,rotation_)
createRing(14.9,0.02,100,0xffffff,position_,rotation_)
createRing(22.8,0.02,100,0xffffff,position_,rotation_)
createRing(77.8,0.02,100,0xffffff,position_,rotation_)
createRing(142.6,0.02,100,0xffffff,position_,rotation_)
createRing(449.8,0.02,100,0xffffff,position_,rotation_)
createRing(590,0.02,100,0xffffff,position_,rotation_)
