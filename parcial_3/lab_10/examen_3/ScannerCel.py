...
concat_original = cv2.hconcat([img1, img2])
cv2.imshow('Imagenes Originales', concat_original)
#===============================================================================================
...
threshold = 80
imgThresholdSust = Ts.getThresholding(imgResultSust,threshold)
# cv2.imshow("Sustraccion Thresolding", imgResultSust)

# Concatenando imágenes, 2 filas por 4 columnas
concat_h2 = cv2.hconcat([imgResultSust, imgThresholdSust])
cv2.imshow('Resultados Sustraccion', concat_h2)
#===============================================================================================
...
threshold = 150
imgThresholdDiv = Ts.getThresholding(imgConstrast,threshold)
# cv2.imshow("Division Thresolding", imgThresholdDiv)


concat_v = cv2.hconcat([imgResultDiv, imgConstrast,imgThresholdDiv])
cv2.imshow('Resultados Division', concat_v)
